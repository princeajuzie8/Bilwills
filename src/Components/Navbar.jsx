        ...
        <div className="general">
          ...
          <ul>
            ...
            <Tooltip title="darktheme/lighttheme" arrow placement="right">
              <li>
                {theme === "light" ? (
                  <RiMoonLine onClick={Themetogler} />
                ) : (
                  <RiSunLine onClick={Themetogler} />
                )}
              </li>
            </Tooltip>
          </ul>
          <Tooltip title={userInfo.displayName} arrow placement="top">
            <div className="user">
              {loading ? (
                <Skeleton
                  circle
                ...
                <img src={userInfo.photoURL} height={30} width={30} alt="" />
              )}
            </div>
          </Tooltip>
        </div>
